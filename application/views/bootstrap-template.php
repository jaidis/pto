...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/assets/css/fontawesome-4.7.0.css" media="screen">
  </head>
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <ul class="nav navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="http://builtwithbootstrap.com/" target="_blank">Built With Bootstrap <i class="fa fa-heart ml-2"></i></a>
            </li>
            <li class="nav-item">
...
Cras justo odio
    ...
    <script src="/assets/js/popper-1.14.0.min.js"></script>
    <script src="/assets/js/bootstrap-4-1.0.min.js"></script>
  </body>
</html>
